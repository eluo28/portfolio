...
- Built a Temporal-based async decisioning framework and implemented its first use case to automate bank transactions reviews, saving 2000+ manual hours to date while enabling rapid reuse across similar workflows
